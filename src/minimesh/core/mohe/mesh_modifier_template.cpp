#include <minimesh/core/mohe/mesh_modifier_template.hpp>
...
//
int Mesh_modifier_template::get_halfedge_between_vertices(const int v0, const int v1)
{
...
bool Mesh_modifier_template::flip_edge(const int he_index)
{
	//
